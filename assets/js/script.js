$(document).ready(function() {
    ...
    // PEDIDO
      ...
      $(document).on('click', '#confirmAddToCartBtn', function() {
          ...
          carro.push({ name: itemName, price: itemPrice });
          total += itemPrice;
      ...
      // Variables con el formato que deben cumplir los campos de dirección, número de tarjeta, cvc y fecha de expiración
      var formatoDireccion = /^[a-zA-Z0-9\s]+ #[0-9]{4}$/; // Debe terminar con " #XXXX"
      var formatoTarjeta = /^[0-9]{16}$/; // 16 dígitos
      var formatoCVC = /^[0-9]{3}$/; // 3 dígitos
      var formatoExp = /^(0[1-9]|1[0-2])\/[0-9]{4}$/; // MM/YYYY

      // Validación en tiempo real para Delivery Address
      ...
      // Validación en tiempo real para Customer Name
      $("#inputCustName").on("input", function() {
      ...
      // Validación en tiempo real para Phone Number
      ...
      // Validación en tiempo real para Card Number
      ...
      // Validación en tiempo real para CVC
      ...
      // Validación en tiempo real para fecha de expiración de tarjeta
      ...
      $("#checkoutButton").on('click', function() {
        ...
        } else if (!formatoDireccion.test(direccion)) {
            $("#inputDireccion").addClass("is-invalid");
            $("#direccionError").text("Please enter a valid address.").show();
            formularioValido = false;
        }
        ...
        if (telefono.trim() === '') {
            ...
            formularioValido = false;
        } else if (telefono.length !== 9 || telefono < 900000000) {
            $("#inputCustPhone").addClass("is-invalid");
            $("#custPhoneError").text("Please, enter a valid phone number.").show();
            formularioValido = false;
        }
        ...
        if (expDate.trim() === '') {
            ...
            formularioValido = false;
        } else if (!formatoExp.test(expDate)) {
            $("#inputExp").addClass("is-invalid");
            $("#expError").text("Please enter a valid expiration date (MM/YYYY format)").show();
            formularioValido = false;
        } else {
